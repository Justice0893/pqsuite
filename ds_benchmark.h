...
#define OS_LINUX  1 
#define OS_TARGET OS_LINUX    // Testing code fixed for Linux
#define TARGET 1
...
#define PRINT_TIMER_AVG(op_name) \
	printf("%-30s %15" PRIu64 " %15.3f %15.3f %15.3f\n", (op_name), _bench_iterations, ((double) _bench_time_cumulative) / 1000000.0, _bench_time_mean, _bench_time_stdev); \
